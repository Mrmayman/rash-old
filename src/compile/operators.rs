...
impl<'a> ParseState<'a> {
    fn get_operator_registers(
        ...
        self.register_set_to_input(current_block, register1, "NUM1", sprite);
        self.register_set_to_input(current_block, register2, "NUM2", sprite);
        (register1, register2)
    }
    ...
    pub fn c_operators_add(
        ...
        let (register1, register2) = self.get_operator_registers(current_block, sprite);
    ...
    pub fn c_operators_greater(
        ...
        self.register_set_to_input(current_block, register1, "OPERAND1", sprite);
        self.register_set_to_input(current_block, register2, "OPERAND2", sprite);
